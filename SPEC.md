...
- [x] `/boundgravel` (ไทย) — โค้ด+รูป+TDS เสร็จ 26 ก.ค. 2026 **รอเจ้าของ QA บน workers.dev** / TDS ในบ้านตัวเอง (`files/boundgravel-tds.pdf` Issue 1.0) / รูปชุดเต็ม 51 ใบจาก zip ลูกค้า (hero = master.jpg pack shot) / **มติเนื้อหา BoundGravel:** สายนี้ใช้ doctrine เดียวกับ PondMax — ห้ามคำ "Epoxy" ทุกที่ ใช้ "Polymer" แทน, branding วัตถุดิบเขียนได้แค่ "Curing system powered by Huntsman (Advanced Materials)" ห้ามเปิดเผยรหัสสารตั้งต้น / ต่างจาก PondMax: สูตรนี้**ไม่เติม solvent จริง** เคลม "100% solids — ไม่เติม solvent" ได้ (มติเจ้าของ 26 ก.ค.) / ภาพลูกค้า = ภาพตัวอย่างเท่านั้น ห้ามเขียน caption บรรยายวิธีทำ ให้บรรยายความสวยงาม / คลิป YouTube 7 ตัวฝัง iframe + คลิป FB share/v/ เป็นปุ่มลิงก์ออก / **ค้าง:** (1) สูตรส่วนผสมเดียว "BoundGravel Flex" (Covestro) — teaser ขึ้นหน้าแล้วชี้แชทเพจ รอเจ้าของส่งราคา+วิธีใช้มาเติมเป็น section เต็ม (2) เจ้าของยัง confirm การเขียน "Polymer Technology จาก Covestro" บนหน้าเว็บ — ถ้าไม่เอาให้ตัดเหลือ "เทคโนโลยี Polymer จากเยอรมนี" (3) หน้า EN รอ batch ตามมติเดิม
