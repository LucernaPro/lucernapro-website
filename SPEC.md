...
8.7 **TDS:** สินค้าที่มีไฟล์ TDS ให้มีปุ่มเดียวชี้ `/files/{slug}-tds.pdf` / สินค้าที่ยังไม่มีไฟล์ ข้ามได้ แต่ **Claude ต้องเตือนเจ้าของทุกเซสชันที่แตะหน้านั้น** ว่ายังไม่มี TDS จนกว่าจะมีไฟล์หรือเจ้าของสั่งปิดเคสถาวร (สถานะปัจจุบัน: **SiliconePro ยังไม่มี TDS — เตือนต่อทุกเซสชัน**)
