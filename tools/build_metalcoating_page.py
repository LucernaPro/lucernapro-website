...
สินค้าตัวเดียวกับ EasyClean (สูตร/สเปคเดียวกัน — Pist 23 ก.ย. 2026) · ราคา Metal Coating: 100 g 1,290 (Pist 23 ก.ย. 2026, เฉพาะหมวดนี้) — ขายขนาดเดียว (Pist: "ขายแค่ 100 กรัมพอ จะได้แปลกไปจากตัวอื่น") ส่ง 70 แต่แยกหน้าเพื่อโลหะ:
...
<section class="buybox" id="uses">
  <div class="wrap">
    ...
    <div class="pts">
      ...
      <div class="pt"><span class="ic">🔧</span><div><h4>มีด เครื่องมือ และของโลหะในบ้าน</h4><p>มีดครัวเหล็กคาร์บอน เครื่องมือช่าง ลูกบิด ราวบันได รั้วและประตูเหล็กที่ทาสีแล้ว แผงเครื่องจักร — ปกป้องผิวที่ยังดีให้ดีต่อไปอีกนาน อายุฟิล์มจากการทดสอบ 2–3 ปี</p></div></div>
    </div>
  </div>
</section>
  ...
  <div class="wrap">
    ...
    <div class="story-grid">
      ...
      <div class="story-body">
        ...
        <div class="beats">
          <div class="beat"><div class="k">หลักการ</div><p>ฟิล์มนาโนพอลิซิลอกเซนโครงสร้างแฟรกทัล เติมนาโนทังสเตนไตรออกไซด์และนาโนทินออกไซด์ — ยึดเกาะโลหะเกรด 0 (Cross-cut) และเป็นชั้นกั้นน้ำกับอากาศไม่ให้ถึงเนื้อโลหะ อายุฟิล์มจากการทดสอบ <b>2–3 ปี</b></p></div>
    ...
    <div class="speccard">
      <table>
        ...
        <tbody>
          ...
          <tr><td>ทนละอองน้ำเกลือ (Salt Spray)</td><td>96 ชม. — ไม่ลอก ไม่แตก ไม่เปลี่ยนสี ไม่เป็นสนิม</td></tr>
...
''' + PRICE_ROWS % {'sqm': 'ตร.ม.'} + r'''
          <tr data-calc="skip"><td class="sz">จำนวนมาก<br><small style="font-family:var(--body);font-weight:400;font-size:12.5px;color:var(--muted)">โรงแรม / อู่ / ร้าน detailing</small></td><td>หลายขวดต่อครั้ง</td><td class="pr">ราคาโครงการ — สอบถาม</td></tr>
        </tbody>
      </table>
    </div>
...
<section class="story" id="straight">
  <div class="wrap">
    ...
    <div class="story-grid">
      ...
      <div class="story-body">
        <div class="beats">
          <div class="beat"><div class="k">1 · "ชะลอสนิม" ไม่ใช่ "กันสนิมตลอดชีพ"</div><p>ฟิล์มหนา 8–12 ไมครอน กันความชื้นได้ตราบที่ฟิล์มยังปิดผิวอยู่ — <b>รอยขูดลึกที่ทะลุฟิล์ม สนิมเริ่มได้ตรงนั้น</b> ของที่โดนกระแทกขูดหนักต้องตรวจและซ่อมจุดที่เสีย อายุฟิล์มจากการทดสอบ 2–3 ปี ไม่ใช่ตลอดไป</p></div>
  ...
  <div class="wrap">
    ...
    <div class="pricecard">
      <table data-calc="1" data-shipping="70">
        ...
        <tbody>
''' + PRICE_ROWS % {'sqm': 'm²'} + r'''
          <tr data-calc="skip"><td class="sz">Volume<br><small style="font-family:var(--body);font-weight:400;font-size:12.5px;color:var(--muted)">hotels / workshops / detailers</small></td><td>Several packs at a time</td><td class="pr">Project pricing — ask us</td></tr>
        </tbody>
      </table>
    </div>
