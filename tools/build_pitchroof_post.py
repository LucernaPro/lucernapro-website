...
TH_BODY = """  <article>
    ...
    <figure class="hero"><img src="/img/post/{slug}-hero.webp" alt="แผนที่จุดตายของหลังคากระเบื้องคอนกรีต CPAC (ปูนครอบสัน กระเบื้องแตก ตะเข้ราง แนวชนผนัง) และหลังคาเมทัลชีท (หัวสกรู รอยซ้อนแผ่น รอบท่อเจาะ สนิมรูพรุน)" width="1200" height="900"><figcaption>สองวัสดุ สองแผนที่จุดตาย — แต่หลักเดียวกัน: หลังคาลาดเอียงรั่วเป็นจุด ไม่ใช่ทั้งผืน</figcaption></figure>
    <section class="step">
    ...
    <section class="step">
      <h2><span class="n">04</span>ทำไมทุกจุดข้างบนถึงเริ่มที่ SpackleFlex</h2>
      ...
      <p>และ Straight Talk ข้อที่เราย้ำกับลูกค้าทุกราย: <b>ค่าเคมีไม่ใช่ต้นทุนแพงของงานหลังคา — ค่าแรงกับความเสี่ยงตอนปีนขึ้นไปต่างหาก</b> ฉะนั้นขึ้นไปรอบเดียว ไล่เก็บให้ครบทุกจุดตามแผนที่ข้อ 02–03 อย่าอุดแค่จุดที่คิดว่าใช่จุดเดียวแล้วลงมารอลุ้น เพราะถ้าพลาด เท่ากับจ่ายค่าปีนอีกรอบเต็มๆ</p>
    </section>
    <section class="step">
      <h2><span class="n">05</span>จบแค่โป๊ว หรือไปต่อ — คอมโบทับหน้าเลือกตามงบ</h2>
    ...
    <section class="step">
      <h2><span class="n">06</span>สรุป — หลังคาไม่ใช่ดาดฟ้า อย่าใช้แผนเดียวกัน</h2>
  ...
  <div class="prods"><span class="lbl">สินค้าที่ใช้ในงานนี้:</span><a href="/spackleflex">SpackleFlex</a><a href="/siliconepro">SiliconePro</a><a href="/exotic">Exotic</a><a href="/heatshield">HeatShield</a></div>
...
EN_BODY = """  <article>
    ...
    <figure class="hero"><img src="/img/post/{slug}-hero-en.webp" alt="Kill-spot map for a CPAC concrete-tile roof (ridge cap mortar, cracked tiles, the valley, wall junction) and a metal sheet roof (screw heads, overlap seams, pipe penetrations, pinhole rust)" width="1200" height="900"><figcaption>Two materials, two kill-spot maps — one principle: pitched roofs leak at points, not planes</figcaption></figure>
    <section class="step">
    ...
    <section class="step">
      <h2><span class="n">04</span>Why every one of those spots starts with SpackleFlex</h2>
    ...
    <section class="step">
      <h2><span class="n">06</span>The wrap — a roof is not a deck; don't run the same play</h2>
  ...
  <div class="prods"><span class="lbl">Products used in this job:</span><a href="/en/spackleflex">SpackleFlex</a><a href="/en/siliconepro">SiliconePro</a><a href="/en/exotic">Exotic</a><a href="/en/heatshield">HeatShield</a></div>
