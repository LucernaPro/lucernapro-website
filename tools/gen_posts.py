  ...
  "th": {
   ...
   "steps": [
    ...
    {"h":"มี Certificate และผลทดสอบรองรับเพื่อการส่งออกทั่วโลก",
     ...
     "figs":[("solar-panel-defender-feibo-lab-05.webp","ผลงานพิสูจน์แล้วด้วย Certificate"),
  ...
  "en": {
   ...
   "steps": [
    ...
    {"h":"Certificates and test reports supporting worldwide export",
     ...
     "figs":[("solar-panel-defender-feibo-lab-05.webp","Proven work, backed by certificates."),
