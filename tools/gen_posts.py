  ...
  "th": {
   ...
   "steps": [
    ...
    {"h":"เจอจุดจริงแล้วค่อยเลือกวิธีซ่อมให้ตรงจุด",
     "text":["พอยืนยันจุดรั่วจริงแล้ว ถ้าเป็นรอยต่อหรือรอยแตกแนวลึกให้อุดด้วย DeepStick ก่อน ปล่อยให้เซ็ตตัวเต็มที่ แล้วค่อยเคลือบทับด้วย Marine Guard เพื่อปิดผิวให้สนิทอีกชั้น หลักการคือหาให้เจอก่อนทา ไม่ใช่ทาสุ่มทั้งพื้นที่แล้วหวังว่าจะหาย"],
     "figs":[]},
   ],
   "prods":[("DeepStick","/deepstick"),("Marine Guard","/marineguard")],
  },
  "en": {
   ...
   "steps": [
    ...
    {"h":"Found the real spot? Now fix that spot specifically",
     "text":["Once the leak point is confirmed, fill any joint or deep crack with DeepStick first and let it fully set, then coat over it with Marine Guard for a complete seal. The whole principle: find it before you coat it — don't coat the whole area and hope."],
     "figs":[]},
   ],
   "prods":[("DeepStick","/en/deepstick"),("Marine Guard","/en/marineguard")],
  },
 },
 {
