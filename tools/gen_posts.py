...
POSTS = [
 ...
 # (ถอนออก 9 ส.ค. 2026) เคสไซโล "ชมพลังของ-deepstick-กันชัดๆ" ย้ายไป build_silo_post.py — รูปทั้งหมดเป็นไฟล์ local ใน /img/post แล้ว ห้ามฟื้นเวอร์ชัน wix
 {
...
<aside class="mnav" id="mnav" aria-label="เมนูหลัก">
  ...
  <form class="mnav-search" id="siteSearch" action="/search" method="get" role="search"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="11" cy="11" r="7"/><path d="m20 20-3.8-3.8"/></svg><input type="search" name="q" placeholder="ค้นหาสินค้า / เคสหน้างาน…" aria-label="ค้นหา" autocomplete="off"></form>
...
POSTS_V2 = [
 {
  ...
  "th": {
   ...
   "desc": "Solar Panel Defender ไม่ได้เกิดจากการเอาน้ำยาเคลือบเงาทั่วไปหรือเคลือบสีรถมาดัดแปลง — พาไปดูเบื้องหลัง R&D ของ Feibo เมืองฉางชา ต้นทาง Raw Material เกรดพรีเมียมระดับ Nano Technology ก่อนนำมาผลิตและควบคุมคุณภาพในประเทศไทย",
   "cat_label": "เคลือบปกป้อง / กาว",
   "hero": ("solar-panel-defender-feibo-lab-00.webp", "ห้องปฏิบัติการ R&D ของ Feibo เมืองฉางชา — โต๊ะทดสอบสูตร ตู้อบทดสอบความทนทาน และระบบดูดไอระเหย (Fume Hood) ที่ใช้พัฒนา Raw Material สำหรับงานเคลือบแผงโซลาร์เซลล์โดยเฉพาะ"),
   "intro": [
    ...
    "เราทำงานร่วมกับบริษัท Feibo ณ เมืองฉางชา ประเทศจีน ซึ่งเป็นผู้วิจัยพัฒนาและผู้ผลิต Raw Material ชั้นนำที่มีมาตรฐานระดับสากล เพื่อนำเข้า Raw Material เกรดพรีเมียมที่สุดมาทำการผลิตและควบคุมคุณภาพในประเทศไทย — เคสนี้เราพาไปดูเบื้องหลังของ Feibo กันชัดๆ ว่าทำไมเราถึงเลือกที่นี่",
   ],
   "steps": [
    ...
    {"h":"Advanced Laboratory — สเกลการทำงานที่จริงจังและได้มาตรฐาน",
     "text":["จากภาพรวมของ Feibo คุณจะเห็นถึงสเกลการทำงานที่จริงจัง ห้อง Lab วิจัยเพียบพร้อมไปด้วยอุปกรณ์วิเคราะห์ทางเคมี ระบบจัดการมลพิษ (Fume Hood) และตู้อบสำหรับทดสอบความทนทานต่อสภาพอากาศ — สูตรที่ออกจากที่นี่ผ่านการทดสอบซ้ำในสภาวะจำลองก่อนเสมอ ไม่ใช่ผสมแล้วบรรจุขายเลย"],
     "figs":[("solar-panel-defender-feibo-lab-01.webp","ทีมวิจัยของ Feibo ขณะทำงานในห้องปฏิบัติการ")]},
    {"h":"Feibo — ผู้พัฒนาเทคโนโลยีเคลือบผิวนาโนที่ LucernaPro นำเข้า Raw Material มาผลิตในไทย",
     "text":["Feibo เป็นบริษัทเทคโนโลยีเคมีเคลือบผิวจากเมือง Changsha ประเทศจีน ที่ได้รับการรับรองสถานะ National High-Tech Enterprise จากภาครัฐจีน สะท้อนมาตรฐานด้านการวิจัยและพัฒนาในระดับอุตสาหกรรม ไม่ใช่ผู้ผลิตเคมีทั่วไป",
             "ทีมพัฒนาสูตรของ Feibo มีประสบการณ์ตรงด้าน Protective Coating ให้กับโครงการภาครัฐหลายโครงการ และมีโครงสร้างห้องปฏิบัติการที่ครบวงจร ประกอบด้วย"],
     "html":['<ul style="margin:14px 0 0 22px;display:grid;gap:8px"><li><b>Formulation Lab</b> — ควบคุม Raw Material ตาม Batch และ Lot Number อย่างเป็นระบบ</li><li><b>QUV Weathering Chamber</b> — ทดสอบความคงทนต่อสภาพอากาศแบบเร่งเวลา</li><li><b>Spectrophotometer</b> — วัดค่า Light Transmittance ด้วยข้อมูลเชิงตัวเลข</li><li><b>Testing Bench</b> — ทดสอบสูตรบนพื้นผิวจริงหลายประเภทก่อนอนุมัติใช้งาน</li></ul>',
             '<p>LucernaPro เป็นผู้นำเข้า Raw Material จาก Feibo เพื่อผลิตสินค้าเองในประเทศไทย โดยควบคุมคุณภาพและปรับสูตรให้เหมาะสมกับสภาพอากาศเขตร้อนภายในประเทศทั้งหมด</p>'],
     "figs":[]},
    {"h":"โฟกัสงานโซลาร์เซลล์แบบครบวงจร ไม่ใช่เคมีทั่วไปที่แถมงานโซลาร์",
     "text":["สิ่งที่ทำให้เรามั่นใจอีกอย่างคือที่นี่หายใจเป็นงานโซลาร์เซลล์จริงๆ ทั้งสารเคลือบ อุปกรณ์ดูแลรักษาแผง และแผงจริงสำหรับทดสอบ ถูกจัดแสดงและใช้งานอยู่ในที่เดียวกัน ปัญหาหน้างานจริงของแผงโซลาร์เซลล์คือโจทย์หลักของ Feibo ไม่ใช่งานเสริม"],
     "figs":[("solar-panel-defender-feibo-lab-03.webp","โซนสาธิตของ Feibo — อุปกรณ์ทำความสะอาดแผงครบระบบ ติดตั้งคู่กับแผงโซลาร์เซลล์จริงขนาดเต็ม"),
             ("solar-panel-defender-feibo-lab-04.webp","แปรงล้างแผง หัวฉีดน้ำ และลูกกลิ้งสำหรับงานแผงโซลาร์เซลล์")]},
    {"h":"มี Certificate และผลทดสอบรองรับเพื่อการส่งออกทั่วโลก",
     "text":["Raw Material จาก Feibo มี Certificate และผลทดสอบรองรับเพื่อการส่งออกทั่วโลก ใบรับรองและรางวัลจัดแสดงอยู่คู่กับตัวอย่างวัสดุจริงให้ตรวจสอบได้ — สำหรับเราเรื่องนี้สำคัญ เพราะเอกสารทดสอบคือสิ่งที่แยก \u201cของจริง\u201d ออกจากคำโฆษณา"],
     "figs":[("solar-panel-defender-feibo-lab-05.webp","ใบรับรองและรางวัลของ Feibo จัดแสดงคู่กับโซนทดสอบวัสดุ"),
             ("solar-panel-defender-feibo-lab-02.webp","ชั้นจัดแสดง Raw Material และตัวอย่างชิ้นงานทดสอบ")]},
  ...
  "en": {
   ...
   "desc": "Solar Panel Defender isn't a repurposed car polish or generic gloss coating — take a look behind the scenes at Feibo in Changsha, the source of the premium nano-grade raw material we manufacture and quality-control in Thailand.",
   ...
   "intro": [
    ...
    "We work with Feibo, a leading R&D and raw-material manufacturer in Changsha, China, operating to international standards — importing their most premium raw material grade for manufacturing and quality control in Thailand. In this case study, we take you behind the scenes to show exactly why we chose this partner.",
   ],
   "steps": [
    ...
    {"h":"An advanced laboratory — serious scale, serious standards",
     "text":["One look inside Feibo shows the scale of the operation: a research lab fully equipped with chemical analysis instruments, fume-extraction systems, and climate ovens for weathering tests. Every formula that leaves this facility has been through repeated testing under simulated conditions — nothing gets mixed and bottled straight for sale."],
     "figs":[("solar-panel-defender-feibo-lab-01.webp","Feibo's research team at work in the laboratory.")]},
    {"h":"Feibo — the nano surface-coating technology developer behind our raw material",
     "text":["Feibo is a surface-coating chemical technology company from Changsha, China, certified as a National High-Tech Enterprise by the Chinese government — a status that reflects industrial-grade research and development standards, not an ordinary chemical manufacturer.",
             "Feibo's formulation team has direct protective-coating experience across multiple government projects, and runs a fully integrated laboratory structure consisting of:"],
     "html":['<ul style="margin:14px 0 0 22px;display:grid;gap:8px"><li><b>Formulation Lab</b> — systematic batch and lot-number control of raw materials</li><li><b>QUV Weathering Chamber</b> — accelerated weathering-resistance testing</li><li><b>Spectrophotometer</b> — light-transmittance measurement backed by numerical data</li><li><b>Testing Bench</b> — formula testing on multiple real substrates before approval for use</li></ul>',
             '<p>LucernaPro imports the raw material from Feibo and manufactures the finished product in Thailand, with all quality control and tropical-climate formula adjustment done in-house.</p>'],
     "figs":[]},
    {"h":"Fully focused on solar — not a general chemical shop with a solar side line",
     "text":["What gives us extra confidence is that this place lives and breathes solar. Coatings, panel-maintenance equipment, and full-size test panels are displayed and used together in one facility. Real-world solar panel problems are Feibo's core mission, not an afterthought."],
     "figs":[("solar-panel-defender-feibo-lab-03.webp","Feibo's demo zone — a complete panel-cleaning system installed alongside a real full-size solar panel."),
             ("solar-panel-defender-feibo-lab-04.webp","Panel-washing brushes, water-fed heads, and rollers for solar panel work.")]},
    {"h":"Certificates and test reports supporting worldwide export",
     "text":["The raw materials from Feibo carry certificates and test reports that support export worldwide. Certifications and awards are displayed right alongside physical material samples, open for inspection — and to us that matters, because test documentation is what separates the real thing from marketing claims."],
     "figs":[("solar-panel-defender-feibo-lab-05.webp","Feibo's certifications and awards, displayed beside the material-testing zone."),
             ("solar-panel-defender-feibo-lab-02.webp","Display shelves of raw materials and test specimens.")]},
  ...
  "th": {
   ...
   "steps": [
    ...
    {"h":"หยุดเติมน้ำ ปิดระบบ แล้วปล่อยให้ระดับลดเอง",
     ...
     "figs":[("pool-leak-level-test-01.webp","ช่วงทดสอบ: หยุดเติมน้ำ ปิดปั๊ม งดใช้สระ แล้วเฝ้าจดระดับน้ำวันละครั้งจนกว่าระดับจะหยุดนิ่ง")]},
  ...
  "en": {
   ...
   "steps": [
    ...
    {"h":"Stop filling, switch everything off, and let the level fall",
     ...
     "figs":[("pool-leak-level-test-01.webp","During the test: no topping up, pump off, pool closed — note the level once a day and wait for it to stand still")]},
 ...
 },
 {
  ...
  "thumb": "finding-the-real-leak-point-01.webp",
  "th": {
