...
CASES.append(dict(slug=s, ngal=6,
 th=dict(title="ลานกลองเซียงซี — หินสลัก ราวสะพาน และประติมากรรมกลางแจ้งที่ต้องอยู่ได้เอง",
  ...
  steps=[
   ...
   ("02","ราวหินสะพาน — ยาวทั้งแนว ไล่ทำทีละช่วง",["ราวหินสลักลายทั้งสองฝั่งสะพาน ทีมงานจอดรถตู้อุปกรณ์ไว้ข้างทางเป็นจุดพักของ แล้วเดินไล่ทำบนทางเท้าทีละช่วง กั้นทางเดินสั้นๆ ให้คนยังเดินผ่านได้ ราวแบบนี้คือสิ่งที่เทศบาลล้างด้วยแรงดันสูงทุกปี — หลังทำระบบ ฝนล้างให้เอง"],[(3,"ช่างเคลือบราวหินสะพาน มีรถตู้อุปกรณ์จอดข้าง","รถตู้อุปกรณ์จอดข้างทางเป็นจุดพักของ ทีมงานเดินไล่ทำบนทางเท้าทีละช่วง — กั้นทางเดินสั้นๆ คนยังเดินผ่านได้"),(4,"ราวหินสลักลายบนสะพานในเมือง","ราวสะพานยาวทั้งแนวหลังทำ — ลายสลักยังคมเหมือนเดิม เพราะไม่ต้องโดนแรงดันสูงอีก")]),
