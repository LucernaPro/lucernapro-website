...
TH_DECIDE = dict(
    ...
    l2=["ฟิล์มหนา ทน UV ไม่เหลือง แช่น้ำถาวร", "เกิดมาเพื่องานกลางแจ้งที่โดนแดดทั้งวัน", "งบจำกัด: มีรุ่นรองในเว็บให้เทียบ"],
...
EN_DECIDE = dict(
    ...
    l2=["Thick film, UV-stable, handles standing water", "Built for full-sun outdoor duty", "On a budget? Compare the lighter options on-site"],
