...
<section class="howto" id="proof">
  <div class="wrap">
    <h2 class="sec-h">See it first — <em>what a coated surface does</em></h2>
    <p class="sec-sub">A demonstration clip of a surface coated with EasyClean — watch what water and grime can and can't do to it</p>
    <div class="vidgrid vert solo">
      <figure>
        <div class="fbv v916"><iframe src="https://www.facebook.com/plugins/video.php?height=476&href=https%3A%2F%2Fwww.facebook.com%2Freel%2F862710706836529%2F&show_text=false&width=267&t=0" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share" loading="lazy" title="EasyClean demonstration clip"></iframe></div>
        <figcaption>EasyClean demonstration clip from our Facebook page</figcaption>
      </figure>
    </div>
  </div>
</section>
