...
TH_BODY = """  <article>
    ...
    <section class="step">
      ...
      <figure><img src="/img/post/{slug}-roller.webp" alt="ใช้ลูกกลิ้งเคลือบน้ำยาโทนอำพันบนพื้นปูนเปลือย เห็นเส้นแบ่งชัดระหว่างส่วนที่เคลือบแล้วเงาวาวกับพื้นปูนแห้ง" loading="lazy" width="1600" height="1200"><figcaption>เส้นแบ่งเล่าเรื่องเอง: ฝั่งที่เคลือบแล้วผิวปิดเงาวาว ฝั่งที่ยังไม่ถึงคือปูนเปลือยที่น้ำเดินผ่านได้ (ภาพประกอบ)</figcaption></figure>
    ...
    <section class="step">
      ...
      <figure><img src="/img/post/{slug}-groutwet.webp" alt="พื้นกระเบื้องที่หน้ากระเบื้องแห้งสะอาด แต่ร่องยาแนวดำเปียกและมีน้ำเจิ่งตามแนวร่อง" loading="lazy" width="1600" height="1200"><figcaption>ดูให้ชัด: หน้ากระเบื้องแห้ง แต่ร่องยาแนวดำเปียกและมีคราบขาวตามแนว — น้ำเลือกทางเดินของมันเอง (ภาพประกอบ)</figcaption></figure>
      ...
      <figure><img src="/img/post/{slug}-corner.webp" alt="ใช้เกรียงอัดเนื้อโป๊วลงแนวมุมพื้นชนผนังบนพื้นกระเบื้อง แนวที่อุดเสร็จเรียบต่อเนื่อง" loading="lazy" width="1600" height="1200"><figcaption>มุมพื้นชนผนัง อัดตัวโป๊วให้เต็มแล้วปาดเรียบเป็นแนวต่อเนื่อง — จุดที่ฟิล์มและยาแนวมักแพ้ ให้ตัวโป๊วจัดการ (ภาพประกอบ)</figcaption></figure>
    </section>
    <section class="step">
