...
TH_BODY = """  <article>
    ...
    <figure class="hero"><img src="/img/post/{slug}-hero.webp" alt="พื้นบ้านปูนเปลือยมีน้ำซึมขึ้นตามแนวรอยร้าว คราบเกลือขาวผุดตามรอยร้าวและโคนผนัง สีผนังโป่งลอกแนวล่าง" width="1600" height="1200"><figcaption>อาการครบในภาพเดียว: น้ำเจิ่งตามแนวรอยร้าว เกลือขาว (Efflorescence) ผุดตามรอยและโคนผนัง สีโป่งลอกแนวล่าง</figcaption></figure>
    <section class="step">
    ...
    <section class="step">
      ...
      <figure><img src="/img/post/{slug}-roller.webp" alt="ใช้ลูกกลิ้งเคลือบน้ำยาโทนอำพันบนพื้นปูนเปลือย เห็นเส้นแบ่งชัดระหว่างส่วนที่เคลือบแล้วเงาวาวกับพื้นปูนแห้ง" loading="lazy" width="1600" height="1200"><figcaption>เส้นแบ่งเล่าเรื่องเอง: ฝั่งที่เคลือบแล้วผิวปิดเงาวาว ฝั่งที่ยังไม่ถึงคือปูนเปลือยที่น้ำเดินผ่านได้</figcaption></figure>
      <p><b>Straight Talk สามข้อก่อนตัดสินใจ:</b> ข้อแรก ผิว MarineGuard โดนแสงสะสมแล้วจะเหลืองตัว งานอยู่อาศัยที่อยากได้พื้นสีสวย ให้ทาสีพื้น PU ทับหน้า ได้ทั้งสีที่ต้องการและอายุการใช้งานที่ยาวขึ้น ข้อสอง <b>งานฝั่ง Negative ไม่มีใครการันตี 100% ได้</b> — แรงดันน้ำจริงของหน้างานคุณคือตัวตัดสิน สิ่งที่เราให้ได้คือระบบที่แรงยึดเกาะสูงที่สุดเท่าที่ทาเองได้จริง ไม่ใช่คำสัญญาลอยๆ ข้อสาม — เงื่อนไขตายของทุกระบบทา: <b>เนื้อปูนต้องยังแน่นอยู่</b> ปูนที่เสื่อมจนลูบแล้วร่อนเป็นผง ยุ่ยลึกทั้งเนื้อ ทาอะไรลงไปฟิล์มก็แค่เกาะอยู่บนผงที่พร้อมหลุดตามกันไป — เคสแบบนั้นต้องสกัดส่วนที่ยุ่ยออกแล้วซ่อมเนื้อปูนให้กลับมาแน่นก่อน ไม่มีน้ำยาตัวไหนในตลาดข้ามขั้นตอนนี้ได้ และเราจะไม่โกหกว่าของเราข้ามได้</p>
    </section>
    <section class="step">
      ...
      <figure><img src="/img/post/{slug}-groutwet.webp" alt="พื้นกระเบื้องที่หน้ากระเบื้องแห้งสะอาด แต่ร่องยาแนวดำเปียกและมีน้ำเจิ่งตามแนวร่อง" loading="lazy" width="1600" height="1200"><figcaption>ดูให้ชัด: หน้ากระเบื้องแห้ง แต่ร่องยาแนวดำเปียกและมีคราบขาวตามแนว — น้ำเลือกทางเดินของมันเอง</figcaption></figure>
      ...
      <figure><img src="/img/post/{slug}-corner.webp" alt="ใช้เกรียงอัดเนื้อโป๊วลงแนวมุมพื้นชนผนังบนพื้นกระเบื้อง แนวที่อุดเสร็จเรียบต่อเนื่อง" loading="lazy" width="1600" height="1200"><figcaption>มุมพื้นชนผนัง อัดตัวโป๊วให้เต็มแล้วปาดเรียบเป็นแนวต่อเนื่อง — จุดที่ฟิล์มและยาแนวมักแพ้ ให้ตัวโป๊วจัดการ</figcaption></figure>
    </section>
    <section class="step">
      ...
      <p><b>Straight Talk: ทางลัดนั้นเราลองให้แล้วด้วยเงินของเราเอง</b> — เทระบบ Epoxy Self-Leveling บางๆ ทับหน้ากระเบื้องทั้งผืน ผลคือ <b>ไม่อยู่</b> ผิวเคลือบกระเบื้องลื่นและพื้นที่ยึดเกาะน้อยเกินไป ใช้งานได้ไม่นานขอบเริ่มเผยอ แล้วล่อนตามกันทั้งแผ่น เสียทั้งค่าของและค่าเวลารื้อ — และเพื่อแฟร์กับตัววัสดุ: ระบบเดียวกันนี้ถ้าเทบน <b>พื้นปูนเปลือย</b> ที่ผิวหยาบและดูดซึม มีโอกาสรอด ตัวแปรที่ฆ่ามันในเคสนี้คือ <b>ผิวเคลือบกระเบื้อง</b> ล้วนๆ ไม่ใช่ตัวน้ำยา</p>
      <p>ทางที่เราเห็นว่าจบจริงมีทางเดียว: ใช้เครื่องเจียรใส่ใบตัด <b>กรีดร่องยาแนวให้กว้างและลึกขึ้น</b> เปิดพื้นที่ยึดเกาะให้วัสดุ แล้วอัด <a href="/epoxygrout">Epoxy TileGrout</a> ให้เต็มเสมอผิว — งานฝุ่นเยอะและเหนื่อยกว่าเทข้ามหน้ากระเบื้องแน่นอน แต่เป็นการแลกที่คุ้ม เพราะทำรอบเดียวแล้วไม่ต้องกลับมารื้อซ้ำ</p>
    ...
    <section class="step">
      ...
      <p>ปิดทางหลักแล้ว น้ำที่ยังมีแรงดันอยู่อาจย้ายไปโผล่ทางรองที่ยังเปิดอยู่ — ถ้าเจอแบบนั้น ไม่ได้แปลว่าระบบที่ทำไปพัง แปลว่า <b>ถึงคิวประตูบานถัดไป</b> วิธีทำงานที่ถูกและประหยัดที่สุดคือปิดจุดหนักสุดก่อน รอฝนตกจริงแล้วเช็คผล ค่อยไล่ปิดจุดต่อไป ดีกว่าเหมาทำทุกอย่างพร้อมกันโดยไม่รู้ว่าตัวไหนได้ผล — และถ้าอาการยังเบาหรืองบยังไม่พร้อมเคลือบทั้งผืน <b>เริ่มจากอัดเฉพาะจุดปัญหาด้วยตัวโป๊ว</b>อย่าง PatchPro ตามรอยร้าวและมุมห้องก่อน ก็เป็นหมากเปิดเกมที่สมเหตุสมผล: ปิดประตูบานหนักสุดด้วยเงินน้อยสุด แล้วดูผลจริงก่อนตัดสินใจลงทุนต่อ</p>
...
EN_BODY = """  <article>
    ...
    <section class="step">
      ...
      <figure><img src="/img/post/{slug}-roller.webp" alt="Rolling an amber-toned coating onto a bare concrete floor, a clear boundary between the glossy coated area and the dry concrete" loading="lazy" width="1600" height="1200"><figcaption>The boundary tells the story: the coated side is sealed and glossy, the side ahead is bare concrete that water can travel through (illustrative image)</figcaption></figure>
      <p><b>Three pieces of Straight Talk before you decide:</b> first, MarineGuard ambers with accumulated light — for living areas where looks matter, topcoat it with a PU floor paint and get both the color you want and a longer service life. Second, <b>nobody can guarantee 100% on the negative side</b> — the real water pressure under your slab is the referee. What we can give you is the highest-adhesion system you can realistically apply yourself, not an empty promise. Third — the dead-end condition for every coating system: <b>the concrete itself must still be sound</b>. Concrete so degraded that it powders under your hand, crumbly deep into the body, will shed any film along with the dust it's gripping. That case needs the crumbled material chiseled out and the concrete repaired solid first — no product on the market skips that step, and we won't pretend ours does.</p>
    </section>
    <section class="step">
      ...
      <figure><img src="/img/post/{slug}-groutwet.webp" alt="Tiled floor with clean dry tile faces but dark wet grout lines and water pooling along the joints" loading="lazy" width="1600" height="1200"><figcaption>Look closely: the tile faces are dry while the grout lines are dark, wet, and edged with white residue — the water picks its own path (illustrative image)</figcaption></figure>
      ...
      <figure><img src="/img/post/{slug}-corner.webp" alt="Pressing repair filler into the wall-to-floor corner joint on a tiled floor with a putty knife, the finished section smooth and continuous" loading="lazy" width="1600" height="1200"><figcaption>The wall-to-floor corner: pack the filler full and trowel it into one continuous line — the spot where films and grout usually lose, handled by the filler (illustrative image)</figcaption></figure>
    </section>
    <section class="step">
      ...
      <p><b>Straight Talk: we tried that shortcut with our own money</b> — pouring a thin self-leveling epoxy system across the whole tiled surface. The result: <b>it didn't hold</b>. Glazed tile is slick and the bonding area is simply too small; before long the edges lifted and it peeled off in sheets. You pay for the material, then pay again to strip it. And to be fair to the material itself: the same system poured onto <b>bare, absorbent concrete</b> has a real chance of holding — what killed it here was the <b>glazed tile surface</b>, not the product.</p>
      <p>The only route we have seen genuinely finish the job: take an angle grinder with a cutting disc and <b>cut the grout lines wider and deeper</b>, opening up real bonding area, then pack <a href="/en/epoxygrout">Epoxy TileGrout</a> in flush. It is dustier and harder work than pouring over the top — and worth every minute, because you do it once and never come back to redo it.</p>
